...
### 👩 Kadın Kullanıcı Arayüzü Tasarım Örneği
<img src="images/dashboard_female.png" alt="FitAI Dashboard Design Mockup - Female User" width="100%" />

*Görsel 1: FitAI Kadın Kullanıcı Arayüzü Tasarım Örneği*

---

### 👨 Erkek Kullanıcı Arayüzü Tasarım Örneği
...
* **Kişiselleştirilmiş Tercih Formu:** Kullanıcı, kombin oluşturmak için favori renklerini, giyim tarzını (Spor, Klasik, Modern vb.), katılacağı etkinlik türünü (İş Görüşmesi, Akşam Yemeği vb.) ve kombin havasını (Vibe) belirtebilir.
